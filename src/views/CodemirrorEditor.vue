    ...
    <el-container>
      ...
      <el-main class="main-body">
        <el-row class="main-section">
          ...
          <css-editor :show-css-editor="showCssEditor" @showCssEditor="showCssEditor = !showCssEditor"></css-editor>
        </el-row>
      </el-main>
    </el-container>
...
export default {
  ...
  methods: {
    ...
    cssChanged() {
      ...
      let theme = this.themes[this.currentPageTheme]

      theme = customCssWithTemplate(json, theme)
